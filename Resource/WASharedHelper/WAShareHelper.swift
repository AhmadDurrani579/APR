...
//                APIManager.sharedInstance.customPOP(isError: true, message: "Error message try again")
   ...
   class func getFormattedDateSpecific(string: String) -> String{
        let dateFormatterGet = DateFormatter()
        dateFormatterGet.dateFormat = "yyyy-MM-dd"
...
//        print("Date",dateFormatterPrint.string(from: date!)) // Feb 01,2018
    ...
    class func getFormattedDate2(string: String) -> String {
        let dateFormatterGet = DateFormatter()
        dateFormatterGet.dateFormat = "yyyy-MM-dd HH:mm:ss"
...
//
////        homeNavigation.navigationBar.layer.masksToBounds = false
////        homeNavigation.navigationBar.layer.shadowColor = UIColor.black.cgColor
////        homeNavigation.navigationBar.layer.shadowOpacity = 0.8
////        homeNavigation.navigationBar.layer.shadowOffset = CGSize(width: 0, height: 2.0)
////        homeNavigation.navigationBar.layer.shadowRadius = 2
//
